...
const features = [
  {
    Icon: MdStorage,
    title: "Cloud Storage",
    description: "Up to 100GB for your UI components projects",
  },
  {
    Icon: MdAccountCircle,
    title: "Unlimited Accounts",
    description: "Create unlimited accounts to manage and share your components",
  },
  { Icon: MdApi, title: "API Access", description: "Integrate CreatoUI components with your apps" },
  {
    Icon: MdDomain,
    title: "Custom Domain",
    description: "Add your own domain to host your UI components library",
  },
  { Icon: MdChat, title: "Live Chat", description: "Get instant support and updates from CreatoUI" },
  {
    Icon: MdShare,
    title: "Share Information",
    description: "Easily share your UI components with your team and collaborators",
  },
];
